...
/*
 * Abstract class defined with constants and the order of Employee elements present in the Input file
 */
...
public abstract class EmployeeFile {
	...
	/*
	 * If the sequence order for elements is changed in input file, it's enough to change the ordering in the method getElementList().
	 */
